...
st.markdown(
    """
    **Bioinformatics Data Science Portfolio** | *Engineering Toolkit: Perl, SQL, Python, and XGradient Boost Multi-Class Modeling*  
    This interface parses input genetic variant features, transform them to one-hot-encoded arrays, and process them with 
    gradient boosted trees to forecast their clinical significance.
    """
)
st.write("---")
...
with col2:
    ...
    # Log-transforming genetic position entered by user
